...
export function ContatoCliente({
  ...
  return (
    <div className="bg-[#0A0A0A] border border-[#262626] p-3 space-y-2">
      <div>
        <p className="text-[9px] font-archivo font-medium tracking-widest uppercase text-[#525252]">De / para</p>
        <p className="font-archivo text-sm font-medium text-[#FAFAFA]">{nome}</p>
      </div>

      <div>
        <p className="text-[9px] font-archivo font-medium tracking-widest uppercase text-[#525252] mb-1">WhatsApp</p>
        <div className="flex items-center gap-2">
          <span className="flex-1 font-display text-lg font-medium text-[#FAFAFA] tabular-nums tracking-wide">
            {telefone}
          </span>
          <button
            onClick={copiar}
            className="shrink-0 flex items-center gap-1 border border-[#525252] text-[#FAFAFA] text-[10px] font-archivo
              font-medium tracking-wider uppercase px-2.5 py-1.5 transition-colors hover:border-[#FAFAFA]"
          >
          ...
          <a
            ...
            className="shrink-0 flex items-center gap-1 bg-[#FAFAFA] text-[#0A0A0A] text-[10px] font-archivo
              font-medium tracking-wider uppercase px-2.5 py-1.5 transition-colors hover:bg-[#E5E5E5]"
          >
